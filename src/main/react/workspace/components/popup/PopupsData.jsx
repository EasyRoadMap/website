...
const transferControlDescription = (name) => {
    return (
        <span>
            Вы уверены что хотите передать управление рабочей областью участнику 
...
const removeParticipantDecsription = (name) => {
    return (
        <span>
            Вы уверены, что хотите исключить из рабочей области учаcтника 
            <span className={styles.descriptionBolder}>{" " + name}?</span>
        </span>
    );
}
const removeImageDecsription = () => {
    return (
        <span>
            Вы уверены, что хотите удалить текущее изображение проекта?
        </span>
    );
}
