...
const tryConfirmEmail = (email, code, password, name, showPopup, setters, navigateLinks, navigate) => {
    signUpConfirmEmail(email, code)
  .then((response) => {
    tryCompleteSignUp(email, password, name, showPopup, setters, navigateLinks, navigate)
  })
  .catch((err) => {
...
const tryCompleteSignUp = (email, password, name, showPopup, setters, navigateLinks, navigate) => {
