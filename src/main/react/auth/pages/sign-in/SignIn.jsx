...
const Form = () => {
  ...
  setErrorsFromOtherPages(location, {"email": setErrorEmail, "password": setErrorPassword});
      ...
      <ForgotPasswordButton 
        ...
        callback={
          () => {
            ...
            tryGetRecovery(email, showPopup, {"email": setErrorEmail, "password": setErrorPassword}, navigate, setPending);
          }
        }
        active={!pending}
      />
